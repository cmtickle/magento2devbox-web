 ...
 */
class MagentoOneInstall extends AbstractCommand
{
    /**
     * @var array
     */
    ...
    {
        $this->setName('magentoone:install')
            ->setDescription('Setup Magento One and all components')
            ->setHelp('This command allows you to setup Magento One and all components.');
    }
