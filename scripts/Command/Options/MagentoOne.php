 ...
 */
class MagentoOne extends AbstractOptions
{
    ...
    protected static function getOptions()
    {
        return [
            ...
            /*static::EDITION => [
                ...
                'question' => 'Which edition of Magento you want to be installed (please, choose CE or EE ... ONLY CE SUPPORTED FOR NOW) %default%'
            ],*/
            static::VERSION => [
                'default' => static::getDefaultValue('MAGENTO_VERSION', '1.9'),
                'description' => 'Version of Magento to install.',
                'question' => 'Which version of Magento you want to be installed (i.e. 1.8 or 1.9 or leave empty for latest) %default%'
            ],
            static::BACKEND_PATH => [
                'initial' => true,
            ...
            static::STATE_PATH => [
                'default' => static::getDefaultValue('MAGENTO_STATE_PATH', '/home/magento1/state'),
